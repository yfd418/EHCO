...
let presenceListeners: Set<(users: Set<string>) => void> = new Set()
let typingListeners: Set<(users: Set<string>) => void> = new Set()
let globalOnlineUsers = new Set<string>()
let globalTypingUsers = new Set<string>()
...
export function usePresence(userId: string | undefined) {
  ...
  useEffect(() => {
    ...
    // 立即同步当前状态
    setOnlineUsers(new Set(globalOnlineUsers))
    setTypingUsers(new Set(globalTypingUsers))
